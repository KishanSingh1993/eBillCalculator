...
public class CourseRepository {
    ...
    private static class InsertCourseAsyncTask extends AsyncTask<MeterModal, Void, Void> {
        private Dao dao;
        ...
        @Override
        protected Void doInBackground(MeterModal... model) {
    ...
    private static class UpdateCourseAsyncTask extends AsyncTask<MeterModal, Void, Void> {
        private Dao dao;
        ...
        @Override
        protected Void doInBackground(MeterModal... models) {
    ...
    private static class DeleteCourseAsyncTask extends AsyncTask<MeterModal, Void, Void> {
        private Dao dao;
